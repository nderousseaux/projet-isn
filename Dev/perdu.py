...
def perdu():
    ...
    perdu.wm_geometry("700x400") #LA dimension de la fenetre est de 500 pixels sur 300 pixels
    ...
    txt = canvas_C.create_text(330, 180, text="Vous avez fait un accident", font="Arial 25 italic", fill="#FFF000")
