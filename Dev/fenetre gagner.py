...
gagner.wm_geometry("700x400") #LA dimension de la fenetre est de 500 pixels sur 300 pixels
...
txt = canvas_B.create_text(325, 120, text="  GAGNE  ", font="Algerian 40 bold", fill="#B9121B")
